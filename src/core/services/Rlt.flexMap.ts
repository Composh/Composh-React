 ...
 */
const FlexStartEndMapper: IRTLFlexMapper<string> = {
 ...
 */
const FlexRowMapper: IRTLFlexMapper<string> = {
  toRTL(value: string, rtl: boolean): string {
 ...
 */
const FlexWrapMapper: IRTLFlexMapper<string> = {
  toRTL(value: string, rtl: boolean): string {
 ...
 */
export const RtlFlexMap: Record<string, IRTLFlexMapper<any>> = {
